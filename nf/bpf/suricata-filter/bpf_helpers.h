...
#define BPF_ANNOTATE_KV_PAIR(name, type_key, type_val)                                                                                                                                                 \
	...
	struct ____btf_map_##name __attribute__((section(".maps." #name), used)) ____btf_map_##name = {}
...
static int (*bpf_csum_diff)(void* from, int from_size, void* to, int to_size, int seed) = (void*) BPF_FUNC_csum_diff;
