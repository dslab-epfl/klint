...
__attribute__((__always_inline__)) static inline int tcp_hdr_opt_lookup(void* data, void* data_end, bool is_ipv6, struct real_definition** real, struct packet_description* pckt, bool bypass_lru,
									void* lru_map)
{
