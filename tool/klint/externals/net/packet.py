...
def alloc(state, devices_count):
    ...
    data_addr = state.heap.allocate(1, 2 * PACKET_MTU, name="packet_data") # TODO: allocate with packet_length size instead; find another way to deal with BPF's adjust_head
