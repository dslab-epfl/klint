...
from klint.externals.os import clock
from klint.externals.os import config
from klint.externals.os import log
from klint.externals.os import memory
from klint.externals.os import pci
from klint.externals.net import packet
from klint.externals.net import tx
from klint.externals.structs import map
from klint.externals.structs import index_pool
from klint.externals.structs import cht
from klint.externals.structs import lpm
from klint.externals.verif import verif
...
def find_fixedpoint_states(states_data):
    ...
    while True:
        ...
        (states, inference_results, reached_fixpoint) = ghostmaps.infer_invariants(states, result_states, inference_results)
        statistics.work_end()
        if reached_fixpoint:
